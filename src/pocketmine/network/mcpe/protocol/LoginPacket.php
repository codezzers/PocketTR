...
class LoginPacket extends DataPacket{
	...
	public function mayHaveUnreadBytes() : bool{
		return $this->protocol !== null and !($this->protocol <= ProtocolInfo::CURRENT_PROTOCOL and $this->protocol >= ProtocolInfo::OLDEST_PROTOCOL);
	}
	...
	protected function decodePayload(){
		...
		try{
			...
			if($this->protocol <= ProtocolInfo::CURRENT_PROTOCOL or $this->protocol >= ProtocolInfo::OLDEST_PROTOCOL){
				throw $e;
			}
