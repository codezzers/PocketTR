...
class CobblestoneWall extends Transparent{
	...
	public function getName() : string{
		static $names = [
			self::NONE_MOSSY_WALL => "Kırıktaş",
			self::MOSSY_WALL => "Yosunlu Kırıktaş",
			self::GRANITE_WALL => "Granit",
			self::DIORITE_WALL => "Diorit",
			self::ANDESITE_WALL => "Andezit",
			self::SANDSTONE_WALL => "Kumtaşı",
			self::BRICK_WALL => "Tuğla",
			self::STONE_BRICK_WALL => "Taş Tuğla",
			self::MOSSY_STONE_BRICK_WALL => "Yosunlu Taş Tuğla",
			self::NETHER_BRICK_WALL => "Nether Tuğlası",
			self::END_STONE_BRICK_WALL => "End Taşı Tuğlası",
			self::PRISMARINE_WALL => "Prizmarin",
			self::RED_SANDSTONE_WALL => "Kırmızı Kumtaşı",
			self::RED_NETHER_BRICK_WALL => "Kırmızı Nether Tuğlası"
		];
		return ($names[$this->getVariant()] ?? "Bilinmeyen") . " Duvar";
	}
