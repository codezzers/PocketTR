...
class Flower extends Flowable{
	...
	public function getName() : string{
		static $names = [
			self::TYPE_POPPY => "Gül",
			self::TYPE_BLUE_ORCHID => "Mavi Orkide",
			self::TYPE_ALLIUM => "Allium",
			self::TYPE_AZURE_BLUET => "Azure Bluet",
			self::TYPE_RED_TULIP => "Kırmızı Lale",
			self::TYPE_ORANGE_TULIP => "Turuncu Lale",
			self::TYPE_WHITE_TULIP => "Beyaz Lale",
			self::TYPE_PINK_TULIP => "Pembe Lale",
			self::TYPE_OXEYE_DAISY => "Papatya"
		];
